...
public class Array {
    ...
    public void testBasicArray1() {
        ...
        int[] arr = new int[3]; // 배열 선언 동시에 생성
    ...
    public void testBasicArray2(){
        ...
        /*
            ## Heap 메모리 특징 ##
            1. Heap에 생선된 객체마다 고유한 주소값(참조값)이 부여됨
    ...
    public void testBasicArray3(){
        // 5개 정수 데이터 담는 배열 생성 후 임의의 숫자값 담아 출력
        int[] arr = new int[5];
    ...
    break;
         ...
         */
            ...
            // 3. 각 인덴스별 문자를 char배열의 각 인덱스 자리에 대입
            /*
                arr[0] = str.charAt(0);
                arr[1] = str.charAt(1);
             */
        ...
        /*
            연결이 끊겨진 heap영역에서의 기존 배열 객체는 일정시간 후에 Gc가(가비지 컬렉터)가 삭제시킴
            => 자바에서의 "자동메모리 관리" 특징
            => 개발자는 메모리 관리 신경 쓸 필요 없이 개발에만 집중할 수 있음
         */

    // 만일 현재 배열 객체마저도 제거시키고자 하는
        ...
        public void testEnhancedFor(){
            ...
            // 향상된 for문
            for(int num : arr){ // num = arr[0] => arr[1] => arr[2] ... src[마지막]
                System.out.println(num);
            }
            // 향상된 for문 내의 변수타입은 배열요소 타입으로 작성하면됨
