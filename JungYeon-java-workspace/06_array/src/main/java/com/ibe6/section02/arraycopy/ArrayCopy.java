package com.ibe6.section02.arraycopy;
...
public class ArrayCopy {
    /*
        ...
        1. 배열 복사를 진행하는 경우
           ...
           2) 배열의 크기를 늘리고 기존 배열의 데이터를 옮겨 담을 때
        2. 종류
    ...
    public void testDeepArrayCopy2(){
        /*
            ...
            System.arraycopy(원본배열, 복사를시작인덱스 , 복사본배열, 복사될시작인덱스, 복사할요소개수)
         */
...
//        System.arraycopy(origin, 0, copy, 0, 5);
        System.arraycopy(origin, 1, copy, 6, 4);
...
//        int[] copy = Arrays.copyOf(origin, 3);
    ...
    public void testDeepArrayCopy4(){
        /*
            ## 깊은복사방법4. clone() 활용 ##
            원본배열과 똑같은 길이의 똑같은 데이터들이 담겨있는 새 배열 객체 변환
