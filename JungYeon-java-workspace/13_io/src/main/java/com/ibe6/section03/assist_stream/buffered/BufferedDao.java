package com.ibe6.section03.assist_stream.buffered;
...
public class BufferedDao {
    ...
    public void fileSaver(){
        /*
            ...
            try(try 블럭안에서 사용할 스트림객체 생성) { // try블럭이 다 끝난 후에 자동으로 반납
    ...
    public void fileCopy(){
        ...
        // 복사할 파일
        File origin = new File("C:\\dev\\env\\jdk-17.0.14_7\\NOTICE", "NOTICE"); // 현재 존재하는 파일
