package com.ibe6.section04.throws_handling;
...
public class ThrowsTest {
    ...
    /*
            ...
            즉, 해당 메소드를 호출하는 곳으로 예외를 던지는 방식
                ...
                public 반환타입 메소드명(메개변수) throws 예외클래스1, 예외클래스2, .. {
                       // 예외 발생되는 구문
                }
    */
    ...
    public void exceptionCase() throws IOException{
        ...
        /*
        try {
            String str = br.readLine(); // IOException 예외 핸들링 필수 => try~catch문으로 여기서 해결하거나 trow로 떠넘기기
        }catch (IOException e){
            // 처리내용
        }
        */
