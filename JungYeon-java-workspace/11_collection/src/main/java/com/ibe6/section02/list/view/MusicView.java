package com.ibe6.section02.list.view;

import com.ibe6.section02.list.controller.MusicController;
...
public class MusicView {
    ...
    public void mainMenu() {
        ...
        while (true) {
            ...
            System.out.println("4. 특정 곡 수정"); // 수정할곡명, 수정곡명, 수정가수명 입력 받은 후 요청
            System.out.println("5. 특정 곡 검색");
            System.out.println("6. 가수명을 통해 곡 검색");
    ...
    public void searchArtist(){
        ...
        if(searchTitle.isEmpty()){
            System.out.println("검색된 가수가 없습니다.");
        }else{
