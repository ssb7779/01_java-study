...
public class If {
    ...
    public void testIfExample2() {
        ...
        // 문자열.toUpperCase() : 해당 문자열을 다 대문자로 변경해서 반환
    ...
    public void testNestedIf() {
        ...
        public void testNestedIfExample1() {
            ...
            /*
                실습
                사용자에게 학년과 점수를 입력받아 합격 여부를 판별하여 출력
                사용자가 입력한 학년이
            ...
            int passScore = 0; // 학년별 합격 기준점수를 기록할 변수
            if (grade >= 1 && grade <= 3) {
                passScore = 60;
    ...
    public void testNestedIfExample2() {
        ...
        /*
            실습
            사용자에게 주민번호 (-포함 14글자)을 입력받고
            잘 입력했을 경우 => 성별을 판별해서 '남자" 또는 "여자" 출력
            잘못 입력했을 경우 => "잘못 입력하셨습니다"

            [참고]
            문자열.lenght(): 해당 문자열의 길이 반환
         */
        Scanner sc = new Scanner(System.in);
        System.out.println("주민번호(-포함 14글자):");
