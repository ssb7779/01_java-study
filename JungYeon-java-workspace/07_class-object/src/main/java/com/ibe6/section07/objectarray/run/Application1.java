...
import com.ibe6.section07.objectarray.dto.Car;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
            ## 객체 배열 ##
            1. 레퍼런스변수에 대한 배열
            2. 동일한 타입의 여러 인스턴스들을 각각 취급하지 않고 연속처리할 수 있어서 유용함 (반복문 활용 가능)
        ...
        carArr1[2] = new Car("7025", "맥라렌", 320);
