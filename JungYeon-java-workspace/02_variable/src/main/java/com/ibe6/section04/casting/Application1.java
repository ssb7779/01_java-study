...
public class Application1 {
    ...
    /*
        ## 컴퓨터에서의 값 처리 규칙 ##
        1. 같은 자료형의 값만 대입가능
           즉, 대입연산자를 기준으로 왼쪽과 오른쪽은 동일한 type이여야 됨
           [표현법] 자료형 변수명 = (자료형)값;

        2. 같은 type끼리만 연상 가능 (연산 결과도 같은 type으로 나옴)
           [표현법] 값 + (자료형)값
...
//        byte b3 = b1 + b2; // 에러 발생 => byte나 short 간 연산시 무조건 int형으로 처리
