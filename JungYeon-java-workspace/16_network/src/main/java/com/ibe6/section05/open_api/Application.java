package com.ibe6.section05.open_api;
...
public class Application {
    public static void main(String[] args) {
        ...
        String serviceKey = "8ASm%2B6vjYNdJuxMGv16NIc3%2BAC%2BED3xp3FxQdFdsXf8fCXDvWuBEuG5NriQWmudChXp%2BycpMlpa%2FkwtjoFZxTw%3D%3D";
...
//            System.out.println(responseData); // jsonString (json구조의문자열)
            ...
            /*
                ...
                4. name:value의 조합으로 데이터를 구성함
                5. 자바에서 JSON 데이터를 취급하기 위해 JSON 라이브러리 필요
