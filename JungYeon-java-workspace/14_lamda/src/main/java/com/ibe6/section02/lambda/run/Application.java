package com.ibe6.section02.lambda.run;

import com.ibe6.section02.lambda.my_functional_interface.FuncInterface1;
import com.ibe6.section02.lambda.my_functional_interface.FuncInterface2;
import com.ibe6.section02.lambda.my_functional_interface.FuncInterface3;
import com.ibe6.section02.lambda.my_functional_interface.FuncInterface4;
...
public class Application {
    public static void main(String[] args) {
        ...
        /*
            ...
            4. 장점
               1) 단순함
               2) 컬렉션, 스티림을 연계해서 데이터를 쉽게 조작할 수 있음
        ...
        // case4. 매개변수o, 반환값o 경우
        // public interface FuncInterface { int minus(int x, int y); }
        FuncInterface4 func4_1 = (num1, num2) -> num1 - num2 ; // 단숨 뺄셈
