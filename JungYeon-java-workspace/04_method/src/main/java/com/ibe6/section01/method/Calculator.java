...
public class Calculator {
    ...
    public void sum(int a, double b){} // 이름보다는 개수 순서 타입이 중요!
    ...
    public void minus(int a, int b) {
        ...
        // return; // 자바 컴파일러가 자동으로 return문 작성 //뭔가 삭제?
    }
    ...
    // ======================
        ...
        /*
        실습
        두 정수값을 전달 받아서 두 수 중 더 큰 값을 반환해주는 max 메소드 정의
        두 정수값을 전달 받아서 두 수 중 더 작은 값을 반환해주는 min 메소드 정의
         */
