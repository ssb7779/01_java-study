package com.minkook.section02.example.run;

import com.minkook.section02.example.dto.Archer;
import com.minkook.section02.example.dto.Character;
import com.minkook.section02.example.dto.Mage;
import com.minkook.section02.example.dto.Rogue;
import com.minkook.section02.example.dto.Warrior;
 ...
 */
        ...
        System.out.println("어떤캐릭터를 선택하시겠어요?");
        ...
        if(cNum == 1){
            ...
            System.out.print("첫번째 아이템: ");
            String item1 = sc.nextLine();
            System.out.print("두번째 아이템: ");
            ...
            System.out.print("활개수:");
            int count = sc.nextInt();
            gc = new Archer(gcName,gcHp,gcLevel,gcExp,distance,count);
        }else if(cNum == 4) {
            gc = new Rogue(gcName,gcHp,gcLevel,gcExp);
        }else{
            System.out.println("번호를 잘못입력하셨습니다. 프로그램을 종료합니다.");
            return;
        }
        while(true){
