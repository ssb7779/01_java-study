package com.minkook.section04.overriding;
...
public class SubClass extends SuperClass {
    /*
        ...
        3. 오버라이딩 성립요건
            ...
            4) 접근제어자는 부모메소드의 접근제어자와 같거나 더 넓은 범위여야 됨
            5) 예외처리는 같은 예외이거나 더 구체적(하위)인 예외를 처리해야됨
       4. 오버라이딩 성립불가
            1) private 부모메소는 오버라이딩 불가
       ...
       2. 생략 가능함
       3. 작성 권장함
       4. ㄴ 후에 부모메소드 수정시 -> 오버라이딩 하고있는 자식클래스에 오류로 알려줌
