package com.seungjoo.section03.constant;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        [표현법] final 자료형 상수명; ->값 변경 불가
         */

        final int AGE = 20;
        final String USER_NAME = "SeungJoo"; //다 대문자이면 언더바 사용
        ...
        2.Pascal Case
            ...
            - 자바 클래스명, 인터페이스명
            ex) UserColor, MemeberRule, PracticeApplication
        3.Snake Case
