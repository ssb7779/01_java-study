...
public class Book /*extends Object*/ {
    ...
    /*
        ...
        4. 대표적인 메소드
           1) 객체.toString()      : 객체의 주소값을 가지고 "객체의 타입 + @ + 주소값의16진수해시코드" 문자열 반환
    ...
    /*
        ...
        (인스턴스 래퍼런스 변수 출력시 자동으로 호출되는 메소드)
     */
    /*
    @Override
     ...
     */
       ...
       //Book other = (Book)Objects; // 비교를 위해 타입을 일치시킴
/*
       return no == other.no
 ...
 */
    ...
    public boolean equals(Object o) {
        ...
        Book book = (Book) o;
        return no == book.no && price == book.price
    ...
    public int hashCode() {
        ...
        // 31이라는 ㅗ수값을 가지고 전달되는 필드값들을 통해서 산술연산 진행
