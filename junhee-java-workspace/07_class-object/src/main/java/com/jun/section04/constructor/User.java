...
public class User {
    ...
    /*
        ...
        5. 생성자 종류
           ...
           2) 매개변수 생성자
              - 매개변수 있는 생성자로, 생성자 호추리 전달값을 받아서 사용할 수 있음
    ...
    /*
    public User(String id, String pwd, String name){ // 정석으로 하는 느낌
        this.id= id;
        this.pwd = pwd;
        this.name = name;
        System.out.println("User 클랫의 모든 필드(id, pwd, name)를 초기화하는 생성자 호출됨..");
    }
     */
