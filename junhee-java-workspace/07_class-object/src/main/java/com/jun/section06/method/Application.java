package com.jun.section06.method;

import com.jun.section04.dto.UserDTO;
...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("전달된 배열(원본): " +iArr);
        System.out.println("전달된 배열(원본) 요소: " + Arrays.toString(iArr));

        pt.testArrayTypeParam(iArr.clone());
        System.out.println("메소드 종료 후 배열 요소: " + Arrays.toString(iArr));
        System.out.println("==========================================");

        UserDTO user = new UserDTO("user01", "pass01", "홍길동");
        System.out.println("전달된 인스턴스: " + user);
