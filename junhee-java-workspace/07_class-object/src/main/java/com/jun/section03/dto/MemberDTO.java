...
public class MemberDTO {
    ...
    public boolean getIsActivated(){
        ...
        /*
            ...
            2. 작성 규칙
               1) 특정 패키지에 속해있어야함 (default 패키지 사용금지)
               2) 멤버변수의 접근제어자는 private 으로 선언
               3) 기본생성자가 명시적으로 작성되어야됨
               4) 모든 멤버변수에 접근 가능한 setter(설정자), getter(접근자)가 public으로 작성되어야됨
