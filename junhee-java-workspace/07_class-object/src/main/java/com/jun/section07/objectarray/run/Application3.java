...
import com.jun.section07.controller.PhoneManager;
...
public class Application3 {
    public static void main(String[] args) {
        /*
            ...
            * 시스템 요구사항
            0. 핸드폰 정보로 브랜드명, 핸드폰 이름, 시리즈, 가격 정보를 가질 수 있다.
            1. 현재 판매중인 핸드폰은 총 5개로 이미 정해져있다.
            2. 판매점 내의 모든 폰에 대한 정보가 조회될 수 있어야된다.
            3. 판매점 내의 모든 폰의 평균가를 조회될 수 있어야된다.
        ...
        Phone[] phones = /*new phone */ {
            ...
            , new Phone("삼성", "갤럭시", "s20", 1200000)
            , new Phone("LG", "롤리팝", "2", 1200000)
        };
        ...
        while (true){
            ...
            if(menu==1){
               ...
               double avg = pm.selectPhoneAvgPrice(phones);
                ...
                if (result == 0) {//검색 결과가 없는 경우
                    System.out.println(search + "폰은 판매하지 않습니다.");
                } else {// 검색 결과가 있는 경우
                    System.out.println("구매하고자 하는 " + search + "의 가격은 " + result + "원입니다.");
                }
            }else if(menu==4) {
                    System.out.print("구매하고자 하는 핸드폰(핸드폰명 또는 시리즈명 키워드): ");
                    String search = sc.nextLine();
