...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        String str5 = "oracle";
        /*
            * compareTo(비교)(String)  : 인자로 전달된 문자열과 사전순으로 비교(대소문자 구분)하여 정수 반환
        ...
        System.out.println("compareTo() :" + str4.compareTo(str2)); // -32 (인자로 전달된 문자열이 더 크다)
        ...
        System.out.println("compareToIgnoreCase()" + str2.compareToIgnoreCase(str4)); // 0 같음
        ...
        // > substring(int beginIndex) : 시작인덱스에서부터 문자열의 끝까지를 반환
        ...
        // * replace(CharSequence, CharSequence) : 첫번째 인자 문자열 찾아 두번째 문자열로 변환시킨 새 문자열 반환
        ...
        char[] charArr = newStr.toCharArray(); // {'j','a', 'v', ....}
