...
public class Calculator {
    ...
    /*
        ...
        3. 메소드명이 같은 대신에 반드시 매개변수(타입, 개수, 순서)가 다르게 지정되어야함
     */

    // 두개의 정수값을 전달받아 덧셈연산 후 결과 출력 기능
...
//    public void sum(int num1, int num2){} // 매개변수명은 중요하지 않음
    ...
    */
    ...
    /*
    실습.
    두개의 정수값을 정달받아 뺄셈 연산 결과를 출력해주는 minus 메소드 정의
     */
    public void minus(int a, int b){
        System.out.println("뺌셈 연산 결과 : " + (a - b));
        //return; // 자바 컴파일러가 자동으로 return을 작성
    }
    ...
    /*
        ...
        2. 하나의 데이터만 반환 가능
           (여러개의 값을 반환하고자 할 경우 하나의 데이터로 담아서(배열, 객체, 칼렉션) 반환해야함)
    ...
    /*
        ...
        두 정수값을 전달받아 두 수 중 더 작은 값을 변환해주는 min 메소드 정의
        Application4 에서 각 메소드 호출 해서 테스트해보기
     */
