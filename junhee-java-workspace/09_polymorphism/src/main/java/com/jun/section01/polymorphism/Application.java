package com.jun.section01.polymorphism;

public class Application {
    public static void main(String[] args) {

        System.out.println("1.부모타입 래퍼런스로 부모인스턴스 관리");
        ...
        c1.printChild1();
        c1.printParent();
        // c1 래퍼런스로 Child1, Parnet 둘 다 접근 가능
        c1.print();

        System.out.println("3. 부모타입 래퍼런스로 자식인스턴스 관리");
       ...
       // ((Child1)arr[2]).printChild1(); // ClassCastException (클래스 형변한 오류)
        ...
        for(int i=0; i<arr.length; i++){
            ...
            /*
                ## instanceof 연산자 ##
                레퍼런스변수가 참조하는 실제 인스턴스 타입이 특정 클래스 타입과 일치하는지 비교해주는 연산자
             */
        ...
        /*
            다형성장점2. 모든 이느턴스에 동일한 메세지를 수신하도록 진행
