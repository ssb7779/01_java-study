package com.jun.section04.casting;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        // int iSum = iNum + dNum; // 10.0 + 5.89 => 15.89

        // 해결방법 1. 연산 결과를 int형으로 강제형변환
        ...
        // 실수값을 정수형으로 강제형변환시 => 소수점 아래 부분을 버림 (*데이터 손실 발생 가능)

        //해결방법 3. 연산결과를 double변수에 대입
