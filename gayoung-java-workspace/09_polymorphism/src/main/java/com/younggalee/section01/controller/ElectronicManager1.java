package com.younggalee.section01.controller;
...
public class ElectronicManager1 {
    ...
    private Tablet tab;
    // EM1객체 생성 순간 필드가 메모리상에 할당됨 (생성된 것은 아님)
    ...
    //각 인스턴스들을 반환하기 위한 메소드도 매번 추가해줘야함.....
    // 번거롭고 결합도가 높은 안좋은 코드라고함... 자식클래스에 뭐 하나 바꾸면 다 찾아서 바꿔야하니까...

    //각 자식 타입을 매개변수나 반환타입에 작성하였으므로
    //후에 자식클래스명 같은게 변경될 경우, 여기 와서도 다 변경해야됨
