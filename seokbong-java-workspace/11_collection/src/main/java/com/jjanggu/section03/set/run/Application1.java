...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
             ## Set 컬렉션 ##
             1. 집합 형태로 데이터를 관리
             2. 순서를 유지하지 않은채로 저장(index 같은 개념 x)
             ...
             4. 중복 요소를 판별할 때 해당 요소의 hashCode로 범위를 추리고 eqouls로 요소간에 동등비교를 수행함
         */
...
//        integerSet.add("안녕");
        ...
        // * Set.of(E e1, E e2, ..) : 인자로 전달된 요소들이 담겨있는 Set반환 (unmodifiable)
...
//        stringList.addAll(stringSet);
        ...
        // * Iterator객체.next() : Iterator 공간내의 요소 꺼내 반환 (일회성)
        // * Iterator객체.hasNext() : Iterator 공간내에 요소가 있을 경우 true  반환
