...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        // * get(Object key) : 전달된 key 정보의 valuse를 V 타입으로 반환
        ...
        // * Map.of(k k1, v v1, k k2 v v2,...) : 인자로 전달된 key-value들이 담겨있는 Map반환(unmodifiable map)
        ...
        while(itKey.hasNext()){                     // 3) 반복문으로 키 도출
            ...
            Object value = stu2.get(key);           // 맵으로부터 벨류 정보 뽑기
