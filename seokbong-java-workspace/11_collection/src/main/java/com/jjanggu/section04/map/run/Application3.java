...
import com.jjanggu.section04.map.dto.Snack;
...
public class Application3 {
    public static void main(String[] args) {
        ...
        /*
            ...
            4. 따라서 위와 같은 파일로 데이터를 입출력시 키, 밸류 모두 String으로 작업해야됨
        ...
        // * setProperty(String key, String v
        prop.setProperty("List" , "ArrList");
        ...
        try {
            // * store(OutputStream os, String commit) : Properties에 담겨있는 key-value 들을 문자열 변환해서 파일로 출력
            prop.store(new FileOutputStream("test.properties"), "propertiesTest");

            // * storeToXML (OutputStream os, String commit) : xml 파일로 저장시키고자 할 경우
