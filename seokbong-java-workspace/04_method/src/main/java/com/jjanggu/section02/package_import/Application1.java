...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
            ...
            1. package
            2. 자바 클래스를 저장하는 폴더
            3. 일반적으로 클래스들의 기능과 역할에 ㄸ라 패키지를 구분하여 저장
            4. 패키지가 다르면 동일한 이름의 클래스 만들기 가능
            5. 실제 클래스명은 패키지까지 함께 포함해서 표기함
               ex) Calculator == com.jjanggu.section1.method.Calculator
         */
         ...
         */
        com.jjanggu.section01.method.Calculator calc = new com.jjanggu.section01.method.Calculator();
        calc.sum(10, 3 );
    }
}
