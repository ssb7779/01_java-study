...
import com.jjanggu.section07.objectarray.cotroller.PhoneManager;
    ...
    public static void main(String[] args) {
        /*
            ...
            * 시스템 요구사항
            ...
            1. 현재 판매중인 핸드폰은 총 5개로 이미 정해져 있다
         */
        ...
        while(true){
            ...
            if(menu == 1){
                ...
                if (result == 0) { // 검색결과가 없는 경우
                    System.out.println(search + "에 해당하는 검색결과가 없습니다.");
                } else { // 검색결과가 있는 경우
                    System.out.println("구매하고자 하는 " + search + "의 가격은 " + result + "원 입니다.");
                }

            }else if(menu == 4){
                System.out.println("구매하고자 하는 핸드폰(핸드폰명 또는 시리즈명 키워드 가능):");
                String search = sc.nextLine();
