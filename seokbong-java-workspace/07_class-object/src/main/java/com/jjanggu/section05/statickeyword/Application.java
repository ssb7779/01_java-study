package com.jjanggu.section05.statickeyword;

public class Application {
    public static void main(String[] args) {

        // 프로그램 실행시 이미 StaticKeyword 클래스 내의 staticCount 필드는 메모리에 할당
        ...
        /*
            ## static ##
            1. 프로그램 구동시 곧바로 static 메모리 영역에 할당되도록 하는 에약어
            2. 인스턴스 생성시 마다 인스턴스 변수가 메로리에 할당 되는 걸 방지할 수 있음
               => 메모리를 절약할 수 있음
               => 값을 공유한다거나 유지해야될 때 유용하게 사용 가능
