...
public class NamingTest{
    ...
    public boolean isSpecialWord(String user) throws NamingException{
        ...
        // NamingException발생(“변수 명명규칙에 어긋납니다.(영문자와 ‘_’, ‘$’, 숫자 사용가
        //능))
        return true;
    }

    public boolean isNumFirst(String user) throws NamingException{
        if(user.charAt(0) == '0' || user.charAt(0) == '1' || user.charAt(0) == '2' ||
           user.charAt(0) == '3' || user.charAt(0) == '4' || user.charAt(0) == '5' ||
            user.charAt(0) == '6' || user.charAt(0) == '7' || user.charAt(0) == '8' ||
                user.charAt(0) == '9' ){
