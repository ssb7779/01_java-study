...
public class Application2 {
    ...
    public static void main(String[] args){
        ...
        /*
            ## 변수 선언 및 값 초기화 ##
            1. 변수 선언
               메모리 상에 특정 값을 기록하기 위한 공간을 만드는 과정 // 변수명은 의미 담는것 필요
               [표현법] 자료형 변수명;
            2. 변수에 값 대입
               선언해둔 변수에 값을 담는 과정
               [표현법] 변수명 = 값;
            3. 변수 선언과 동시에 초기화 //1,2를 합친 단계
               [표현법] 자료형 변수명 = 값;
               ...
               1. 논리형 : boolean (1byte)
               2. 정수값 : byte(1byte), short(2byte), int(4byte), long(8byte)
               3. 실수형 : float(4byte) , double(8byte)
               4. 문자형 : char(2byte)

               ## 참조 자료형 (reference type) : 무한개 ##
               1. 문자열 : String
               2. 그 밖에 기본자료형을 제외한 모든 type
         */
        ...
        int i = 210000000;  // 4byte : -21억xxxx ~ 21억xxxx
        ...
        double d = 8.123456789123456789; // 8byte (더 정확한 값을 표현)

        System.out.println("f의 값 : " + f); // 소수점아래 6자리
