package com.jjanggu.section03.constant;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            2. 단, 한 번 담긴 값을 변경할 수 없음
            3. 상수명은 전부 대문자로 작성하는걸 권장 (변수와의 차이를 두기 위해)

            [표현법] final 자료형 상수명;
         */
        final int AGE = 20;
        final String USER_NAME = "Seokbong";
//        AGE = 21;
//        NAME = Seokbok;
    ...
    /*
       ** ## 개발시 사용하는 4가지 명명규칙(Naming Convention) ## **
        ...
        2. Pascal Case
           - Camel Case와 동일하나 시작 문자의 첫 글자도 대문자로 작성하는 방식
           - 자바 클래스명, 인터페이스명
