package com.jjanggu.section03.wrapper;
...
//        Integer boxingNumber = new Integer (intValue1);     // 1_1) 객체 생성 방식 (JDK 9부터 deprecated됨(권장 x))

        Integer boxingNumber1 = Integer.valueOf(intValue1); // 1_2) static 메소드 사용 방식
        Integer boxingNumber2 = intValue2;                  // 1_3) AutoBoxing (JDK 1.5 부터 가능)
...
//        System.out.println(boxingNumber);
        ...
        int unBoxingNumber2 = boxingNumber2;            // 2_2) AutoUnBoxing (JDK 1.5 부터 가능)
