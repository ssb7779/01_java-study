package com.jjanggu.section03.assist_stream.buffered;
...
public class BufferedDao {
    ...
    public void fileSave(){
        ...
        /*
            ...
            스트림을 다 사용하면 다종으로 반납이 진행되게 하는 구문
            JDK 1.7 이상부터 사용 가능
    ...
    public void fileCopy(){
        ...
        // 복사할 파일
        File origin = new File("C:\\dev\\env\\jdk-17.0.14_7","NOTICE");//현존 파일
        File copy = new File("C:\\storage", origin.getName());  // 현재 존재하는 파일x
