...
public class Application {
    public static void main(String[] args) {
            /*
                ## 상속
                1. inheritance
                2. 부모(자식), 자식(하위) 간의 구조로 클래스를 구성하는 개념
                3. 상위 클래스가 가지고 있는 멤버를 하위 클래스에서 새로 작성할 필요 없이
                   마치 내것처럼 사용가능
                4. 단순히 물려받는게 개념보다 조굼 도 나아가면
                   부모(상위) 클래스를 확장(extand) 한다는 갠념을 가짐
                   => 부모꺼를 내것처럼 사용하는거 뿐만 아니라 추가적으로 본인만의 멤버도 작성 가능

                ## 상속의 장점 ##
                1. 새로운 클래서 작성시 기존에 작성된 클래스를 재사용할 수 있음
                   1) 재사용시 새롭게 작성하는것 보다 빠르게 작성 가능 (생산성 향상)
                   2) 공통 코드가 부모 블래스에 존재하므로 수정사항 발생시 부모 클래스 수정만으로 전체적으로 적용(유지보수성 증가)
        ...
        /*
            ...
            Racing is a car  (o)   Car is a RacingCar (x)
            자식클래스 is a 부모클래스
            자식클래스 extend 부모클래스
            자식클래스 -----|> 부모클래스
         */
        ...
        /*
            ...
            하지만 Car를 상속받았기 때문에 어쩔 수 없이 경적소리가 울려
        ...
        /*
            ...
            3. 부모클래스에 있는 메소드를 자식 클래스에서 재정의 할 수 있음 (오버라이딩)
