package com.jjanggu.section03.etc.controller;
...
public class Break {
    ...
    /*
        ...
        2. 주로 반복문 안에서 반복믄이 종료될 조건과 함께 사용
        3. 유의사항
           중첩 반목문일 경우 break문이 속해있는 최근접의 반복문만 종료됨
     */

    public void testBasicBreak(){
        /*
            매번 1~100사이의 랜덤수가 발생되면서 출력됨
            이때 발생되 랜덤값이 5의 배수일 경우 반복이 종료되도록 하시오.
         */
    ...
    public void testBreakExample1() {
        ...
        while(true){
            System.out.println("문자열 입력(종료하고 싶다면 exit을 입력) : ");
