package com.jjanggu.section01.polymorphism;
...
//        ((Child1)arr[2]).printChild1(); // ClassCastException (클래스 형변환 오류)
        ...
        for(int i=0; i < arr.length; i++){
            ...
            /*
                ...
                런타입 당시 실제 인스턴스가 가지는 오버라이딩된 메소드로 바인딩이 바뀌어 동작되는걸 의미함
             */
            arr[i].print();
        }
        /*
            다형성장점2. 모든 인스턴스에 동일한 메세지를 수신하도록 진행
