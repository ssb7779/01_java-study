package com.podoseee.section02.package_import;
    ...
    public static void main(String[] args){
        ...
        /*
            ...
            5. 실제 클래스명은 패키지까지 함께 포함해서 표기함
                ex) Calculator == com.podoseee.section01.method.Calculator
         */
         ...
         */
        com.podoseee.section01.method.Calculator calc = new com.podoseee.section01.method.Calculator();
        calc.sum(10, 3);
