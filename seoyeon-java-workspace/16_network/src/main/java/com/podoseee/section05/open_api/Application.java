...
public class Application {
    public static void main(String[] args) {
        ...
        String serviceKey = "8gf4ZUP2ZjrWPLCk4SNsnlokTiROnPP5R6hMTaiClczbtKr3MIjEPfVImpXTeZvIgf6uJUVuq1WI%2FppQlyXUtg%3D%3D\n";
            ...
            /*
                ...
                5. 자바에서 JSON 데이터를 취급하기 위해 JSON 라이브러리 필요 (JSON-Java)
                   ...
                   3) 제공 주요 메소드
                      ...
                      - getString(key)      : 해당 key의 value를 String으로 반환
                      - getInt(key)
                      - getDouble(key)
                      - get(key)            : 해당 key의 value를 Object으로 반환
             */
