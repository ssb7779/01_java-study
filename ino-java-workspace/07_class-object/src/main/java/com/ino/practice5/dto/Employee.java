...
public class Employee {
    ...
    public String getInformation() {
        return "empNo" + empNo + " empName : " + empName + " dept : " + dept + " job : " +  job + " age : " + age + " gender: " + gender + " salary : " + salary + " bonusPoint: " + bonusPoint + " phone : " + phone + " address : " + address;
    }
}
